				...
				<li>
					<div class="thumbnail">
						<a class="zoomTool" href="product_details.html"
							title="add to cart"><span class="icon-search"></span> Xem sản
							phẩm</a> <img
							...
							<div class="item active">
								<ul class="thumbnails">
									<c:forEach var="item" items="${newproduct}" varStatus="loop">
										<li class="span3">
											<div class="thumbnail">
												<a class="zoomTool" href="<c:url value="product-detail/${item.id_product}"/>"
										...
										<c:if
											test="${ (loop.index + 1) % 4 == 0 || (loop.index + 1)  == newproduct.size()}">
								</ul>
							</div>
							...
							<li class="span4">
								<div class="thumbnail">
									<a class="zoomTool" href="<c:url value="product-detail/${item.id_product}"/>"
										...
										sản phẩm</a> <a href="product_details.html"><img
										src="<c:url value="/assets/user/img/${item.img}"/>" alt=""></a>
									<div class="caption">
										<h5>${item.name}</h5>
										<h4>
											<button class="shopBtn  addCart" type="button" data-id="${item.id_product}"><span class="icon-plus"></span></button> <span
